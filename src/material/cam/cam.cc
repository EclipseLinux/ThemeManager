...
namespace material_color_utilities
{
									   ...
									   const ViewingConditions& viewing_conditions)
	{
		...
		double alpha =
			pow(t, 0.9) *
			pow(1.64 - pow(0.29, viewing_conditions.background_y_to_white_point_y), 0.73);
	...
	Argb IntFromCamAndViewingConditions(Cam cam, ViewingConditions viewing_conditions)
	{
		double alpha =
