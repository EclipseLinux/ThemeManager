...
#include "material/scheme/scheme_expressive.h"
...
namespace material_color_utilities
{
	...
	const std::vector<double> kSecondaryRotations = {45, 95, 45, 20, 45, 90, 45, 45, 45};
	...
	SchemeExpressive::SchemeExpressive(Hct set_source_color_hct, bool set_is_dark)
		: SchemeExpressive::SchemeExpressive(set_source_color_hct, set_is_dark, 0.0)
	{
	}
