...
#include "material/scheme/scheme_vibrant.h"
...
namespace material_color_utilities
{
	...
	const std::vector<double> kSecondaryRotations = {18, 15, 10, 12, 15, 18, 15, 12, 12};

	const std::vector<double> kTertiaryRotations = {35, 30, 20, 25, 30, 35, 30, 25, 25};
