...
#include "material/quantize/wsmeans.h"
...
#include "material/quantize/lab.h"
...
namespace material_color_utilities
{
	...
	struct Swatch
	{
		...
		bool operator<(const Swatch& b) const
		{
									...
									uint16_t max_colors)
	{
		...
		std::vector<std::vector<int>> index_matrix(cluster_count,
												   std::vector<int>(cluster_count, 0));
