...
namespace material_color_utilities
{
	...
	DynamicScheme::DynamicScheme(Argb source_color_argb, Variant variant,
		...
		: source_color_hct(Hct(source_color_argb)), variant(variant), is_dark(is_dark),
		  contrast_level(contrast_level), primary_palette(primary_palette),
		  secondary_palette(secondary_palette), tertiary_palette(tertiary_palette),
	...
	Argb DynamicScheme::SourceColorArgb() const
	{
		return source_color_hct.ToInt();
	}
