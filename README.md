...
It's all based purely on the [Material You](https://m3.material.io/), and generated using their own [scheme generation algorithms](https://github.com/material-foundation/material-color-utilities).
